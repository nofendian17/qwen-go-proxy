...
func TestConfig_Validate_MissingRequiredFields(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expect: "QWEN_OAUTH_BASE_URL cannot be empty",
		},
		{
			...
			expect: "QWEN_OAUTH_CLIENT_ID cannot be empty",
		},
		{
			...
			expect: "QWEN_OAUTH_DEVICE_AUTH_URL cannot be empty",
		},
		{
			...
			expect: "API_BASE_URL cannot be empty",
		},
	}
...
func TestConfig_Validate_InvalidValues(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			config: &Config{
				ServerPort:                 8080,
				QWENOAuthBaseURL:           "https://test-base.com",
				QWENOAuthClientID:          "test-client",
				QWENOAuthDeviceAuthURL:     "https://test-url.com",
				QWENDir:                    ".qwen",
			...
			expect: "LOG_LEVEL must be one of:",
		},
		{
			...
			expect: "RATE_LIMIT_REQUESTS_PER_SECOND must be positive",
		},
		{
